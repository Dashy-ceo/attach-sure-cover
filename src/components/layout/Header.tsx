                ...
                <nav className="container py-4 flex flex-col space-y-4">
                  {isAuthenticated ? (
                    <>
                      ...
                      <Link to="/claims" className="text-foreground/80 hover:text-foreground" onClick={toggleMenu}>Claims</Link>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {isAuthenticated ? (
                <>
                  ...
                  <Link to="/claims" className="text-foreground/80 hover:text-foreground transition-colors">Claims</Link>
                </>
              ) : (
                <>
